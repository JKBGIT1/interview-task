...
As a workaround I'm deploying the ArgoCD CRDs separately using the `k8s/infra/argocd/crds.yaml`. The CRDs in this folder were taken from https://raw.githubusercontent.com/argoproj/argo-cd/refs/tags/v3.3.0/manifests/crds/application-crd.yaml.
